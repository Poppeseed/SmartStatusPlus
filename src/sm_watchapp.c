...
// to make status bar on top
//#define STATUS_LAYER_Y 0
//#define TIME_LAYER_Y (STATUS_LAYER_Y + STATUS_LAYER_HEIGHT - 7)	
...
static BitmapLayer *background_image, *weather_image, *status_image;

static Layer *music_layer, *status_layer, *animated_layer[2];
...
static void click_config_provider(void *context) {
  ...
  window_multi_click_subscribe(BUTTON_ID_UP, 2, 0, 300, true, up_double_click_handler);
  
  window_single_click_subscribe(BUTTON_ID_DOWN, down_click_handler);
  window_long_click_subscribe(BUTTON_ID_DOWN, 700, NULL, down_long_click_handler);
  window_multi_click_subscribe(BUTTON_ID_DOWN, 2, 0, 300, true, down_double_click_handler);
...
static void init(void) {
  ...
  window_stack_push(window, animated);
	...
	status_img = gbitmap_create_with_resource(RESOURCE_ID_IMAGE_STATUS);
	...
	//////////////////////////////////////////////////////////
	// animated weather/calendar
	//////////////////////////////////////////////////////////
	
	animated_layer[WEATHER_LAYER] = layer_create(GRect(0, ANIMATED_LAYER_Y, 144, ANIMATED_LAYER_HEIGHT));
	...
	layer_set_frame(text_layer_get_layer(text_date_layer), GRect(0, DATE_LAYER_Y, 144, DATE_LAYER_HEIGHT));
	...
	layer_set_frame(text_layer_get_layer(text_time_layer), GRect(0, TIME_LAYER_Y, 144, TIME_LAYER_HEIGHT));
	text_layer_set_font(text_time_layer, fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_ROBOTO_BOLD_SUBSET_49)));
	layer_add_child(window_layer, text_layer_get_layer(text_time_layer));

	animated_layer[CALENDAR_LAYER] = layer_create(GRect(144, ANIMATED_LAYER_Y, 144, 45));
...
//	layer_set_hidden(&animated_layer[CALENDAR_LAYER], true);
	...
	music_layer = layer_create(GRect(0, MUSIC_LAYER_Y, 144, MUSIC_LAYER_HEIGHT));
	layer_add_child(window_layer, music_layer);

	music_artist_layer = text_layer_create(GRect(0, 0, 144, 21));
	...
	layer_add_child(music_layer, text_layer_get_layer(music_artist_layer));
	text_layer_set_text(music_artist_layer, "Artist"); 	


	music_song_layer = text_layer_create(GRect(0, 15, 144, 28));
	...
	layer_add_child(music_layer, text_layer_get_layer(music_song_layer));
	...
	status_layer = layer_create(GRect(0, STATUS_LAYER_Y, 144, STATUS_LAYER_HEIGHT));
	layer_add_child(window_layer, status_layer);
		
	status_image = bitmap_layer_create(GRect(0, 0, 144, 13));
	layer_add_child(status_layer, bitmap_layer_get_layer(status_image));
	bitmap_layer_set_bitmap(status_image, status_img);
	
	
	text_mail_layer = text_layer_create(GRect(16, -6, 12, 18));
	text_layer_set_text_alignment(text_mail_layer, GTextAlignmentLeft);
	...
	text_sms_layer = text_layer_create(GRect(43, -6, 12, 18));
	text_layer_set_text_alignment(text_sms_layer, GTextAlignmentLeft);
	...
	text_phone_layer = text_layer_create(GRect(67, -6, 12, 18));
	text_layer_set_text_alignment(text_phone_layer, GTextAlignmentLeft);
